 ...
 * 
 * Let us have more fun by adding another simulated agent class with a different
 * result for the doIt method and see what we now need. We need nothing else and
 * just have to launch this new type of agent: Activators do not care about the
