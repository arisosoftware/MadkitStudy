...
/**
 * This agent is used to model a quite simple environment. Nothing in it; It
 * just defines its boundaries and uses a {@link PropertyProbe} to set the
 * agents' environment field so that they can use the environment's methods once
 * they enter the artificial society.
 */
