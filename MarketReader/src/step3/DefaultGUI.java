 ...
 * 
 * The only thing to do for obtaining a default GUI for an agent is to launch it
 * with the GUI parameter set to true. This could be done either in the MaDKit
 * arguments or when launching an agent.
 */

public class DefaultGUI extends Agent {
	...
	protected void live() {
		...
		launchAgent(new step1.HelloWorldAgent(), true);
		pause(2000);
	}
