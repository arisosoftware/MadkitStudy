...
/**
 * Here, we just start the previous agent but also using the desktop mode of
 * MaDKit.
 * 
 * 
 * 
 ...
 * 
 * 
 * The Desktop is a GUI front end embedding the agents and which features
 * different actions that can help developing MAS applications. The Desktop do
 * not quit when there is no active agent, contrary to the first example.
 */
