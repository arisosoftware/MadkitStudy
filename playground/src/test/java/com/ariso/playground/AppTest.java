...
public class AppTest extends TestCase {
	...
	public void testGZIPEncrpyt() throws Exception {
		...
		byte[] encrypted = GZIP.encryptAndCompress(toEncrypt, "password");

		String decrypted = GZIP.decryptAndDeCompress(encrypted, "password");
	...
	public void testFastJson() throws Exception {
		 ...
		 assertTrue(output.equals("{\"localIp\":\"12.1.12.1\",\"localPort\":1111,\"serverIp\":\"kkasjdfla\",\"serverPort\":2222}"));
