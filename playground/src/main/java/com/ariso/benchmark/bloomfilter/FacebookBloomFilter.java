 ...
 */
public class FacebookBloomFilter<E> implements Serializable {
	 ...
	 */
	public FacebookBloomFilter(double c, int n, int k) {
	 ...
	 *            contain.
	 */
	public FacebookBloomFilter(int bitSetSize, int expectedNumberOElements) {
	 ...
	 */
	public FacebookBloomFilter(double falsePositiveProbability, int expectedNumberOfElements) {
	 ...
	 */
	public FacebookBloomFilter(int bitSetSize, int expectedNumberOfFilterElements, int actualNumberOfFilterElements,
			BitSet filterData) {
	...
	public boolean equals(Object obj) {
		...
		final FacebookBloomFilter<E> other = (FacebookBloomFilter<E>) obj;
...
//
/// **
// same as facebook bloomfilter
// *
// */
// public class SimpleBloomFilter<E> implements Serializable {
// private BitSet bitset;
// private int bitSetSize;
// private double bitsPerElement;
...
// storing hash values as strings
//
...
// * is the number of hash functions used.
// */
// public SimpleBloomFilter(double c, int n, int k) {
// this.expectedNumberOfFilterElements = n;
// this.k = k;
// this.bitsPerElement = c;
// this.bitSetSize = (int) Math.ceil(c * n);
...
// * contain.
// */
// public SimpleBloomFilter(int bitSetSize, int expectedNumberOElements) {
// this(bitSetSize / (double) expectedNumberOElements, expectedNumberOElements,
...
// * is the expected number of elements in the Bloom filter.
// */
// public SimpleBloomFilter(double falsePositiveProbability, int
// expectedNumberOfElements) {
// this(Math.ceil(-(Math.log(falsePositiveProbability) / Math.log(2))) /
// Math.log(2), // c = k / ln(2)
// expectedNumberOfElements, (int)
// Math.ceil(-(Math.log(falsePositiveProbability) / Math.log(2)))); // k =
// // ceil(-log_2(false
// // prob.))
// }
//
...
// * a BitSet representing an existing Bloom filter.
// */
// public SimpleBloomFilter(int bitSetSize, int expectedNumberOfFilterElements,
...
// return false;
// }
// final SimpleBloomFilter<E> other = (SimpleBloomFilter<E>) obj;
...
// public double getFalsePositiveProbability(double numberOfElements) {
// // (1 - e^(-k * n / m)) ^ k
// return Math.pow((1 - Math.exp(-k * (double) numberOfElements / (double)
// bitSetSize)), k);
//
// }
//
